...
import com.nurgundogdu.recyclerviewkullanimi.databinding.FragmentDetaySayfaBinding
...
class DetaySayfaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //tasarim.textView.text = gelenNesne.kisi_ad
        //tasarim.textView2.text = gelenNesne.kisi_tel
